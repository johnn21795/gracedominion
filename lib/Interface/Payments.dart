...
int totalAmount = 0;
Map<String, dynamic> selectedRefData = {};
        ...
        children: [
          Positioned(
            ...
            child: SizedBox(
                ...
                child: TableClass(
                    tableColumns:  {"No" :ColumnSize.S, "Date":ColumnSize.S, "Name":ColumnSize.S, "Description":ColumnSize.M,"Paid":ColumnSize.S,"Account":ColumnSize.S,"Status":ColumnSize.S},
                    tableName: "Payments",
                    searchQuery:  {"Search":cardController.text.toUpperCase(), "StartDate":startDate, "EndDate":endDate},
                    myFunction: (){
                      showOrderDialog(context, selectedRefData);
                    }
                )),
          ...
          Positioned(
              ...
              child: Row(
                children: [
                  SizedBox(width:  screenSize!.width * 0.35, child: TextField(
                    onSubmitted: (query){
                      setState(() { });
                    },
              ...
              content:  SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(top:100,left: 100, child: Text('$totalTransactions', style: const TextStyle(fontFamily: "claredon", fontWeight: FontWeight.bold))),
                    ...
                    Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                                width: 250,
                                child: Text(data["Name"].toString(), style: TextStyle(fontFamily: "Claredon", fontSize: screenSize!.height * 0.015),)),
