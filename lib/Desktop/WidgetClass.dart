...
import '../Warehouse/MainInterface.dart';
import '../Warehouse/Product.dart';
...
//   static addPreference(String key, dynamic value) {
//     sharedPreferences.update(key, (value) => value, ifAbsent: () => value);
//     print("key $key value $value");
//   }
//   static getPreference(String key) {
//     print("get key $key value ${sharedPreferences[key]}");
//     sharedPreferences.containsKey(key) ? sharedPreferences[key] : 0.0;
//   }
// }
...
class _TableClassState extends State<TableClass> {
  ...
  //   await prefs.addPreference('scrollOffset', _scrollController.offset);
  // }
  // void _restoreScrollOffset() async {
  //   SharedPreferences prefs =  SharedPreferences();
  //   double scrollOffset = prefs.getPreference('scrollOffset') ?? 0.0;
  //   _scrollController = ScrollController(initialScrollOffset: scrollOffset);
  //   scrollOffset == 0.0 ? print("Offset is Zero ") :
  //   setState(() {
  //     print("ScrollController position $scrollOffset ");
  //
  //   });
  // }
  //
  ...
  //      loadMoreItems();
  //   }
  //   print("offset Bottom  ${_scrollController.offset}");
  // }
  @override
  void initState()  {
    print("_TableClassState  initializing...");
        ...
        StatefulBuilder(builder: (context, setState){
          return GestureDetector(
            onTap: () {
              ...
              returnData({"Name": e["Name"].toString(), "Offset":MySavedPreferences.getPreference("scrollOffset") });
